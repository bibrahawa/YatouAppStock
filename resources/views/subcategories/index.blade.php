...
@section('main-content')
    ...
    <div class="panel-heading">
        {{-- @can('category.create') --}}
            <a href="{{ route('subcategories.new') }}" class="btn btn-success btn-alt btn-xs" style="border-radius: 0px !important;">
                    ...
                    @foreach($subcategories as $subcategory)
                        <tr>
                            ...
                            <td class="text-center">
                                {{-- @can('category.manage') --}}
                                    <a href="{{ route('subcategories.edit', $subcategory) }}" class="btn btn-info btn-alt btn-xs">
                        ...
                        <div class="modal fade" id="deleteModal{{ $subcategory->id }}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                            <form action="{{ route('subcategories.delete', $subcategory) }}" method="get">
                                @csrf
                                @method('GET')
