...
@section('main-content')
    <div class="panel-heading">
        ...
        @if(count(Request::input()))
            <span class="pull-right">
                <a class="btn btn-default btn-alt btn-xs font-black" href="{{ route('client.index') }}">
    ...
    <div class="modal fade" id="searchModal">
        <div class="modal-dialog">
            <div class="modal-content">
                <form class="form-horizontal" method="GET" action="{{ route('client.index') }}">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <label for="name" class="col-sm-3">{{ trans('core.name') }}</label>
                        <div class="col-sm-9">
                    ...
                    <div class="form-group">
                        <label for="company_name" class="col-sm-3">{{ trans('core.company_name') }}</label>
                        <div class="col-sm-9">
                            <input type="text" name="company_name" value="{{ Request::get('company_name') }}" class="form-control">
                        </div>
                    </div>

                    <div class="form-group">
                        <label for="phone" class="col-sm-3">{{ trans('core.phone') }}</label>
                        <div class="col-sm-9">
                    ...
                    <div class="form-group">
                        <label for="address" class="col-sm-3">{{ trans('core.address') }}</label>
                        <div class="col-sm-9">
