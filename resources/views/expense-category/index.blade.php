...
@section('main-content')
    ...
    <div class="panel-heading">
        ...
        @if(count(Request::input()))
            <span class="pull-right">
                <a class="btn btn-default btn-alt btn-xs" href="{{ route('expense.category.index') }}">
    ...
    <div class="modal fade" id="addModal">
        <div class="modal-dialog">
            <div class="modal-content">
                <form class="" id="ism_form" action="{{ route('expense.category.post') }}" method="POST">
                    @csrf
    ...
    <div class="modal fade" id="searchModal">
        <div class="modal-dialog">
            <div class="modal-content">
                <form class="" id="ism_form">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title">
                       Recherche Expense Category
                    </h4>
                </div>
    ...
    <!-- Search Expense modal ends -->


    <!-- Delete Modal Starts -->
    <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel" aria-hidden="true">
      <form action="{{ route('expense.category.delete') }}" method="POST">
      @csrf
    ...
    <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel" aria-hidden="true">
      <form action="{{ route('expense.category.edit') }}" method="POST">
      @csrf
