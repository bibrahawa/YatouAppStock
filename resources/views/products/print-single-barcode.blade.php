...
@php
    $barcode = 'data:image/png;base64,' . Picqer\Barcode\DNS1D::getBarcodePNG($product->code, "c128A", 1, 33, [1, 1, 1], true);
@endphp
    ...
    <div id='app'>
        ...
        <div class="panel-body">
            <div class="a4paper" id="printableArea">
                <div class="barcode-single-item" v-for="item in items">
                    <div :class="ppp">
                        <p v-if="site_name" class="barcode-info-p">
                            {{ settings('site_name') }}
                        </p>
                        <img src="{{ generateBarcode($product->code) }}" />
