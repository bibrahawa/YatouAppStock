    ...
    <div class="panel-heading">
        ...
        @if(count(Request::input()))
            <span class="pull-right">
                <a class="btn btn-alt btn-default font-black btn-xs" href="{{ route('product.index') }}">
            ...
            <span class="pull-right">
                <div class="btn-group" >
                  ...
                  <ul class="dropdown-menu ">
                    <li>
                        <a href="{{route('product.export.excel')}}" title="Export Excel" >
                            <i class="fa fa-file-excel-o" style="color: #12a823;"></i>
                            {{trans('core.download_excel')}}
                        </a>
                    </li>
                  </ul>
                </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="code" class="col-sm-3">{{ trans('core.product_code') }}</label>
                        <div class="col-sm-9">
                            <input type="text" name="code" class="form-control" value="{{ Request::get('code') }}">
                        </div>
                    </div>
                </div>
