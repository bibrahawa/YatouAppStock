    ...
    <div id="printableArea" class="panel-body">
        ...
        <table class="table table-bordered" width="100%">
            <thead class="table-header-color">
                ...
                <th class="text-center" scope="col">{{ trans('core.ref_no') }}</th>
                <th class="text-center" scope="col">{{ trans('core.client') }}</th>
                <th class="text-center" scope="col">{{ trans('core.product') }}</th>
                <th class="text-center" scope="col">{{ trans('core.total') }}</th>
                <th class="text-center" scope="col">{{ trans('core.warehouse') }}</th>
                <th class="text-center" scope="col">{{ trans('core.date') }}</th>
            </thead>
        ...
        <table style="width: 50%; font-weight: bold;" align="right" class="table table-bordered visible-lg">
            ...
            <tr style="background-color: #F8F9F9; border: 1px solid #ddd;">
                ...
                <td>
                    {{ settings('currency_code') }}
                    {{ twoPlaceDecimal($transactions->sum('total') - $transactions->sum('total_cost_price')) }}
                </td>
            </tr>
