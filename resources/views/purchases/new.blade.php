        ...
        var app = new Vue({
            ...
            methods:{
                ...
                postForm: function () {
                    ...
                    var self = this
                    axios.post('/admin/purchase/new', { purchases: this.purchases, supplier: this.supplier, paid: this.paid, method: this.method, discountType: this.discountType, discount: this.discount, date: this.$refs.sellDate.value })
