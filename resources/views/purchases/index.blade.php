...
@section('main-content')
    <div class="panel-heading">
        ...
        @if (count(Request::input()))
            <span class="pull-right">
                <a class="btn btn-default btn-alt btn-xs" href="{{ route('purchase.index') }}">
                    ...
                    <div class="modal-body">
                        ...
                        @if (settings('enable_purchaser'))
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <select name="supplier" class="form-control selectpicker" data-live-search="true" placeholder="Please select a supplier">
                                        @foreach ($suppliers as $supplier)
                                            <option value="{{ $supplier }}" @if (Request::get('supplier') == $supplier) selected @endif>{{ $supplier }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
    ...
    <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel" aria-hidden="true">
        <form method="POST" action="{{ route('purchase.delete') }}">
            @csrf
