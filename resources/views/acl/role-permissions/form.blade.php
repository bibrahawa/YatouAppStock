...
<div class="panel-body">
    ...
    <form action="{{ route('post.role.permission', $role) }}" method="post" class="form-horizontal bordered-row">
        @csrf
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input
                            ...
                            value="{{ $permission->id }}"
                            @if(in_array(ucwords($permission->type) . ' ' . ucwords($permission->name), $rolePermissionNameLists))
                                checked
                            @endif
                        >
                    </div>
