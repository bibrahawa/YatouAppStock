...
class ClientController extends Controller
{
    ...
    public function postIndex(Request $request)
    {
        ...
        return redirect()->action([ClientController::class, 'getIndex'], $params);
    }
    ...
    public function getClientInvoices(Client $client)
    {
        ...
        return view('clients.invoices')->withInvoices($invoices)->withClient($client);
    }
    ...
    {
        $payments = Payment::where('client_id', $id)->orderBy('date', 'desc');
